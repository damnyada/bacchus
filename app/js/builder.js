...
const NEWS_DOMAIN = 'http://static.evino.com.br/BR/upload/news/content/';
      ...
      sliceTemplate += `<tr>
        <td>
          <table
            ...
            cellspacing="0"
            width="650"
            style="border-collapse:collapse;line-height:100%!important;width:650px"
          >
            <tr>
              <td width="325">
                <a
                  href="${allSlices[count].children[3].value}"
                  target="_blank"
              ...
              <td width="325">
                <a
                  href="${allSlices[count + 1].children[3].value}"
                  target="_blank"
                  rilt="${allSlices[count + 1].children[2].value}"
                >
